...
const CONVERSATION = [
  { from: "them", name: "Maya", text: "Welcome back 👋" },
  { from: "me", text: "Missed this place" },
  { from: "them", name: "Maya", text: "Everything's right where you left it" },
  { from: "them", name: "Maya", text: "Let's pick the conversation back up" },
];
          ...
          <div className="talkie-form-inner">
            <div className="talkie-logo-row">
              ...
              <div>
                ...
                <div className="talkie-logo-sub">Welcome back</div>
              </div>
            </div>
            ...
            <h2 className="talkie-heading">Good to see you again</h2>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button type="submit" className="talkie-submit" disabled={isLoggingIn}>
